...
stock-analysis/            # the skill that ships — this is the product
  ...
  modules/                 # 10 analytical modules + investors/ (8 personas)
...
- **Modules** = 10 analytical (`macro, sector, company-fundamentals, financial-statements,
  valuation, technical, sentiment, risk-position, debate-panel, backtest`) + 8 investor
...
`references/report-template.html`, `modules/debate-panel.md`, `modules/risk-position.md`.
