...
| standard | User asks for analysis/report/target price with a normal research depth | macro, sector, company fundamentals, financial statements, valuation, technical, sentiment, risk | No formal debate; include one counter-thesis paragraph | Complete professional self-contained HTML report |
