...
For stock reports, prefer API-generated daily and weekly charts over prose-only technical analysis. If the main `stock-analysis` skill is active, use its `scripts/fetch_price_charts.py` output when available.
