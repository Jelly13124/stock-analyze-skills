---
name: stock-investor-fisher
description: Use when stock analysis should be filtered through Phil Fisher's investment lens — long-term growth quality, R&D intensity, management depth, scuttlebutt-style qualitative research, conservative investing for the patient — either as a standalone conversation persona, a written persona report, or a Bull/Bear slot in stock-debate-panel.
---

# Phil Fisher Investor Lens
